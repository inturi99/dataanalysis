...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4400__auto__,writer__4401__auto__,opt__4402__auto__){
return cljs.core._write.call(null,writer__4401__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__5794 = o;
(G__5794[reagent.impl.template.cached_prop_name.call(null,k)] = convert_prop_value.call(null,v));
...
return (function() { 
var G__5795__delegate = function (args){
...
var old_5798 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_5798))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_5798)].join(''):class$));
} else {
}
...
reagent.impl.template.has_selection_api_QMARK_ = (function has_selection_api_QMARK_(input_type){
...
var G__5801 = jsprops;
(G__5801["defaultValue"] = value);

(G__5801["onChange"] = ((function (G__5801,v,value,on_change){
return (function (p1__5799_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5799_SHARP_);
});})(G__5801,v,value,on_change))
);
...
reagent.impl.template.reagent_input = (function reagent_input(){
...
var vec__5803 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5803,(0),null);
var id = cljs.core.nth.call(null,vec__5803,(1),null);
var class$ = cljs.core.nth.call(null,vec__5803,(2),null);
...
var temp__4427__auto__ = (function (){var G__5807 = cljs.core.meta.call(null,v);
var G__5807__$1 = (((G__5807 == null))?null:reagent.impl.template.get_key.call(null,G__5807));
return G__5807__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__5809_5810 = v;
var G__5809_5811__$1 = (((G__5809_5810 == null))?null:reagent.impl.template.key_from_vec.call(null,G__5809_5810));
var G__5809_5812__$2 = (((G__5809_5811__$1 == null))?null:(jsprops["key"] = G__5809_5811__$1));
...
reagent.impl.template.native_element = (function native_element(parsed,argv){
...
var p = (function (){var temp__4427__auto__ = (function (){var G__5815 = cljs.core.meta.call(null,argv);
var G__5815__$1 = (((G__5815 == null))?null:reagent.impl.template.get_key.call(null,G__5815));
return G__5815__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__5816 = (((jsprops == null))?{}:jsprops);
(G__5816["key"] = key);
...
var G__5817 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__5817;
continue;
}
} else {
...
var n__4700__auto___5818 = a.length;
var i_5819 = (0);
while(true){
if((i_5819 < n__4700__auto___5818)){
(a[i_5819] = reagent.impl.template.as_element.call(null,(a[i_5819])));
...
var a = cljs.core.into_array.call(null,s);
var n__4700__auto___5821 = a.length;
var i_5822 = (0);
while(true){
if((i_5822 < n__4700__auto___5821)){
var val_5823 = (a[i_5822]);
if((cljs.core.vector_QMARK_.call(null,val_5823)) && ((reagent.impl.template.key_from_vec.call(null,val_5823) == null))){
(o["no-key"] = true);
} else {
}

(a[i_5822] = reagent.impl.template.as_element.call(null,val_5823));

var G__5824 = (i_5822 + (1));
i_5822 = G__5824;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__3801__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
...
var G__5826 = (cljs.core.count.call(null,argv) - first_child);
switch (G__5826) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__5826){
