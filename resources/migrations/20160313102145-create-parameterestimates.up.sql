...
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (1,	'UPS',	'LFPR', 'Andhra Pradesh', 630.7928,	0.01503, -324.497);
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (2,	'UPS',	'LFPR',	'Arunachal Pradesh', 578.2706, 0.80114, -236.777);
...
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (10, 'UPS',	'LFPR',	'Himachal Pradesh',	623.1075,	0.15089,	-261.291);
...
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (15,	'UPS',	'LFPR',	'Madhya Pradesh',	534.7028,	0.02852,	-464.612);
...
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (25,	'UPS',	'LFPR',	'Tamil Nadu',	573.3271,	0.02411,	-423.077);
...
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (29,	'UPS',	'LFPR',	'Uttar Pradesh',	350.5511,	0.01275,	-537.468);
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (30,	'UPS',	'LFPR',	'West Bengal',	845.8581,	-0.00112,	-135.331);
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (31,	'UPS',	'LFPR',	'A & N Islands',	495.8229,	2.96677,	-357.881);
...
INSERT INTO "parameterestimates"(id, type, rate, state, constant, population, gender)VALUES (33,	'UPS',	'LFPR',	'Dadra & Nagar Haveli',	470.6203,	5.32622,	-474.328);
